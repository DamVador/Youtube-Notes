                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <input
                                v-model="form.slug"
                                type="text"
                                class="flex-1 rounded-lg border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:border-blue-500 focus:ring-blue-500"
                            />
                        </div>
